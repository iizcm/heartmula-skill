...
[![Category: Media](https://img.shields.io/badge/Category-Media-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `heartmula-skill` |
...
cp -r media/heartmula ~/.hermes/skills/media/heartmula/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/heartmula-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/heartmula-skill.git ~/.hermes/skills/media/heartmula/
```
...
```text
skill_view(name="media/heartmula")
```
...
```text
Use the heartmula skill to <describe your specific task here>
```
...
```text
Gunakan skill heartmula untuk <deskripsikan tugas spesifik Anda di sini>
```
